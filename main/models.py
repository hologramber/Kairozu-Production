...
class TwoTableData(models.Model):
    ...
    f_prea = models.CharField(max_length=254, blank=True)
    f_posta = models.CharField(max_length=254, blank=True)
    f_note = models.CharField(max_length=254, blank=True)
...
class FourTableData(models.Model):
    ...
    f_prea = models.CharField(max_length=254, blank=True)
    f_preb = models.CharField(max_length=254, blank=True)
    f_prec = models.CharField(max_length=254, blank=True)
    f_posta = models.CharField(max_length=254, blank=True)
    f_postb = models.CharField(max_length=254, blank=True)
    f_postc = models.CharField(max_length=254, blank=True)
